...
# $Id: u64q.programs.Makefile,v 1.57 2018/02/28 23:37:36 igouy-guest Exp $
...
%.fsharpcore_run: %.fsharpcore $(DOTNETCORE)
	...
	-$(DOTNETCORE) build -c Release --no-restore
...
%.fpascal_run: %.pas
	-$(FPASCAL) -FuInclude/fpascal -XXs -O4 -Tlinux $(FPCOPTS) -oFPASCAL_RUN $<
	-mv FPASCAL_RUN $@
